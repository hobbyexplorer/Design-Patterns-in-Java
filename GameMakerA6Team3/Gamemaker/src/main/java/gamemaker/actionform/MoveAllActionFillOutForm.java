...
public class MoveAllActionFillOutForm implements ActionFillOutForm, ChangeListener
{
	// Current JFrame
	private JFrame moveAllActionFillOutFrame;

	// Current JPanel
	private JPanel moveAllActionFillOutPanel;
	 ...
	 */
	public MoveAllActionFillOutForm()
	{
		moveAllActionFillOutFrame = new JFrame();
		moveAllActionFillOutFrame.setVisible(false);
		moveAllActionFillOutFrame.setUndecorated(true);
		moveAllActionFillOutFrame.setSize(new Dimension(Constants.FILL_OUT_FORM_WIDTH, Constants.FILL_OUT_FORM_HEIGHT));
		moveAllActionFillOutFrame.setResizable(false);
		moveAllActionFillOutFrame.setLocationRelativeTo(null);

		moveAllActionFillOutPanel = new JPanel();
		moveAllActionFillOutPanel.setLayout(null);
		moveAllActionFillOutPanel.setBackground(Color.white);
		moveAllActionFillOutPanel.setBorder(BorderFactory.createEtchedBorder(EtchedBorder.RAISED));
		moveAllActionFillOutFrame.add(moveAllActionFillOutPanel);

		titleLabel = new JLabel("Move All Action fill out form:");
		...
		moveAllActionFillOutPanel.add(titleLabel);
		...
		moveAllActionFillOutPanel.add(nextButton);
		moveAllActionFillOutPanel.add(cancelButton);
		...
		moveAllActionFillOutPanel.add(angleSelectionSlider);
	...
	{
		moveAllActionFillOutFrame.setVisible(visibility);
	}
	...
	{
		this.moveAllActionFillOutFrame.dispose();
	}

	@Override
	public JPanel getFillOutForm()
	{
		return this.moveAllActionFillOutPanel;
	}
