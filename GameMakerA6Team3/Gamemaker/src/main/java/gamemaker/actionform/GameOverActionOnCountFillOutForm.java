...
public class GameOverActionOnCountFillOutForm implements ActionFillOutForm
{
	// Current JFrame
	 ...
	 */
	public GameOverActionOnCountFillOutForm()
	{
		...
		countLabel.setBounds(100, 120, 50, 30);
		gameOverActionFillOutFormPanel.add(countLabel);
		
		
		signComboBox = new JComboBox(objectCondition);
		signComboBox.setBounds(170, 120, 50, 30);
		gameOverActionFillOutFormPanel.add(signComboBox);
		
		countField = new JTextField("0");
		countField.setBounds(230, 120, 50, 30);
		gameOverActionFillOutFormPanel.add(countField);
		
		messageLabel = new JLabel("Message: ");
		messageLabel.setBounds(150, 180, 100, 30);
	...
	{
		return (String) signComboBox.getSelectedItem();
	}
