...
import gamemaker.actionform.MoveRightActionFillOutForm;
...
public class MoveRightActionFillOutFormController implements ActionFillOutFormController, ActionListener
{
	...
	public MoveRightActionFillOutFormController(ActionFormsMasterController actionFormsMasterController)
	{
		this.actionFormsMasterController = actionFormsMasterController;
		fillOutForm = new MoveRightActionFillOutForm();
		fillOutForm.AddActionListenerToButtons(this);
		GameMaker.logger.logInfo(this.getClass().getName() + " - Move Right Action Fillout form controller called.");
	...
	public void addAction(){
		...
		rotateImageString = ((MoveRightActionFillOutForm) this.fillOutForm).getRotateSprite().getSelectedItem().toString();
		if(rotateImageString.equalsIgnoreCase("yes"))
			rotateImage = true;
		
		actionToBeAdded = new MoveRight(spriteToAdd, rotateImage);
