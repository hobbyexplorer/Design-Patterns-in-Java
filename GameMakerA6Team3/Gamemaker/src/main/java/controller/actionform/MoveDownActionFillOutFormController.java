...
public class MoveDownActionFillOutFormController implements ActionFillOutFormController, ActionListener
{
	...
	public MoveDownActionFillOutFormController(ActionFormsMasterController actionFormsMasterController)
	{
		this.actionFormsMasterController = actionFormsMasterController;
		fillOutForm = new MoveDownActionFillOutForm();
		fillOutForm.AddActionListenerToButtons(this);
		GameMaker.logger.logInfo(this.getClass().getName() + " - Move Down Action Fillout form controller called.");
	...
	public void addAction(){
		...
		rotateImageString = ((MoveDownActionFillOutForm) this.fillOutForm).getRotateSprite().getSelectedItem().toString();
		if(rotateImageString.equalsIgnoreCase("yes"))
			rotateImage = true;
		
		actionToBeAdded = new MoveDown(spriteToAdd, rotateImage);
