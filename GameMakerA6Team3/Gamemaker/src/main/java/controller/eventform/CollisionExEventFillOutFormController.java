...
import gamemaker.eventform.CollisionExEventFillOutForm;
...
public class CollisionExEventFillOutFormController implements EventFillOutFormController, ActionListener
{
	...
	public CollisionExEventFillOutFormController()
	{
		...
		fillOutForm = new CollisionExEventFillOutForm();
		fillOutForm.AddActionListenerToButtons(this);
		GameMaker.logger.logInfo(this.getClass().getName() + " - collision with exception event fillout form up and waiting for user input.");
	}
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		else if (Constants.NEXT_BUTTON.equalsIgnoreCase(e.getActionCommand()))
		{
			...
			eventToBeAdded = new CollisionEventWithException(spriteOne, spriteTwo, ((CollisionExEventFillOutForm) fillOutForm).getSelectedSprites());
